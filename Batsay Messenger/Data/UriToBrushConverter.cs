...
namespace Batsay_Messenger.Data
{
	public class UriToBrushConverter : IValueConverter
	{
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			...
			return value == null ? (Brush) new SolidColorBrush(Color.FromRgb((byte) random.Next(256),
				(byte) random.Next(256), (byte) random.Next(256))) : new ImageBrush(new BitmapImage((Uri)value));
		}
